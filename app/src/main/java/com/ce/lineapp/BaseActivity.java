...
public class BaseActivity extends AppCompatActivity {
     ...
     */
    protected String[] listArray = {"Mi Turno", "Inicio", "Cerrar Sesión"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setAdapter(new ArrayAdapter<String>(this, R.layout.drawer_list_item, R.id.text1, listArray));
        ...
        actionBarDrawerToggle = new ActionBarDrawerToggle(
                ...
                android.R.drawable.arrow_up_float,     /* nav drawer image to replace 'Up' caret */
